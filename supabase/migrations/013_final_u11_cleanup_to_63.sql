...
-- U11 팀 구조를 최종 정리하기 위한 보조 스크립트입니다.
-- 새 데이터베이스를 만들 때 다시 실행하면 안 됩니다.

BEGIN;
-- U11 팀을 정확히 63개로 정리 (최종 버전)
-- 생성일: 2026-02-05
-- team-names.txt 파일 기준
-- 
-- 실행 순서:
-- 1. 먼저 011_merge_duplicate_teams.sql 실행 (중복 팀 통합)
-- 2. 그 다음 이 파일 실행 (최종 정리)
...
-- 3조 1번: 서귀포FC
UPDATE teams SET group_name1 = '3', group_team_no1 = 1 WHERE id = '8bd515e6-d6c0-42fc-b4f1-a47ae562302e';
...
-- 6조 1번: 쏘니유소년FC U12
UPDATE teams SET group_name1 = '6', group_team_no1 = 1 WHERE id = 'ec8aa4ff-9fc5-4f00-a1aa-5b987193a3aa';
...
-- 10조 1번: 이천수FC U12
UPDATE teams SET group_name1 = '10', group_team_no1 = 1 WHERE id = 'e3568b17-be14-4394-a17a-b6970d19a648';
...
-- 11조 1번: LOJE UTD U12
UPDATE teams SET group_name1 = '11', group_team_no1 = 1 WHERE id = 'c7a2ae73-0eaa-4c97-9c25-aeb75f2fcf8c';
